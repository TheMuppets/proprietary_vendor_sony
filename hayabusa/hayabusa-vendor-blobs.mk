...
PRODUCT_COPY_FILES += \
    ...
    vendor/sony/hayabusa/proprietary/etc/wifi/gsm_domains.conf:system/etc/wifi/gsm_domains.conf \
    vendor/sony/hayabusa/proprietary/etc/wifi/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf \
